...
1. If you want to **formalise** interactions between different actors **in code** instead of using written contracts.  ****_"We will pay you $100 for this task. If we don't agree, then you should go to court" -&gt; "We put $100 in the escrow, and we have Dispute Resolution in case something goes wrong"_ 
...
* DAOs lead to better decision making: easier, done faster and verifiable. 
